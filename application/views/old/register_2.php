	...
	<div class="row row-centered">
        <div class="col-md-8 col-centered">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" required name="terms" onchange="this.setCustomValidity(validity.valueMissing ? 'Please indicate that you accept the Terms and Conditions' : '');" id="field_terms">   <label for="terms">Saya setuju dengan semua <a href="terms.php" title="You may read our terms and conditions by clicking on this link">syarat dan ketentuan</a> registrasi.</label><span class="req">* </span>
            </div>

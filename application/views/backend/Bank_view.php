...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-folder-open"></i> DATA BANK</h3>
				</div>
			</div>
            <!-- page start-->
...
function add_data()
{
    ...
    $('.modal-title').text('Tambah bank'); // Set Title to Bootstrap modal title
}

function edit_data(id_bank)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('bank/ajax_edit')?>/" + id_bank,
        type: "GET",
        dataType: "JSON",
...
function delete_data(id_bank)
{
    if(confirm('Apakah kamu yakin akan menghapus data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('bank/ajax_delete')?>/"+id_bank,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama_bank" placeholder="Nama bank" class="form-control" type="text">

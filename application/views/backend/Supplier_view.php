...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-folder-open"></i> DATA SUPPLIER</h3>
				</div>
			</div>
            <!-- page start-->
...
function selected(){
	...
	$.ajax({
		type: "POST",
		url : "<?php echo site_url('supplier/list_kota')?>/" + selectProvinsi,
		data: selectProvinsi,
		dataType: "JSON",
		...
		{	
			...
			if (selectKotaKab > 0){
				$.ajax({
					type: "POST",
					url : "<?php echo site_url('supplier/list_kecamatan')?>/" +selectKotaKab,
					//data: selectKotaKab,
					dataType: "JSON",
					success: function(data)
					{	
...
function edit_data(id_supplier)
{
    ...
    $.ajax({
        url : "<?php echo site_url('supplier/ajax_edit')?>/"+id_supplier,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {	
			...
			$('[name="kd_Supplier"]').val(data.kd_member);
			$('[name="nama_Supplier"]').val(data.nama_lengkap);
			$('[name="no_Kontak"]').val(data.no_kontak);
			$('[name="alamat_Supplier"]').val(data.alamat);
...
function delete_data(id_supplier)
{
    if(confirm('Apakah kamu yakin akan menghapus data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('supplier/ajax_delete')?>/"+id_supplier,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kd_Supplier" placeholder="Kode Supplier" class="form-control" type="text">
						...
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="alamat_Supplier" placeholder="Alamat Supplier" class="form-control" type="text"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">

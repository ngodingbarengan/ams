...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-folder-open"></i> DATA MEREK</h3>
				</div>
			</div>
            <!-- page start-->
...
function edit_data(id_merek)
{
    ...
    $.ajax({
        url : "<?php echo site_url('merek/ajax_edit')?>/" + id_merek,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Edit Merek'); // Set title to Bootstrap modal title
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('merek/ajax_add')?>";
    } else {
        url = "<?php echo site_url('merek/ajax_update')?>";
    }
...
function delete_data(id_merek)
{
    if(confirm('Apakah kamu yakin akan menghapus data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('merek/ajax_delete')?>/"+id_merek,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {

...
<body>
	...
	<td width="45%">
		<table>
			<tr> 
				<td style="width:120px; vertical-align:top;"><strong><i>Purchase No.</i></strong></td> 
				<td style="width:20px; vertical-align:top;"><strong><i>:</i></strong></td> 
				<td style="width:200px; vertical-align:top;"><strong><i><?php echo $master->nomor_po; ?></i></strong></td> 
			</tr>
			<tr> 
	...
	<table class="table" style="margin-bottom: 0px; margin-top: 30px;"> 
		...
		<tbody> 
			...
			<tr> 
				<td><td> 
				<td>Total PO<td> 
				<td style="text-align:left;"><?php echo number_format($master->total_po, 0, '.', '.'); ?><td> 
			</tr>
			<tr> 
				<td><td> 
				<td>Total PPN<td> 

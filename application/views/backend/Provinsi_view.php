...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-folder-open"></i> DATA PROVINSI</h3>
				</div>
			</div>
            <!-- page start-->
...
<!--tambahan script auto chain -->
<script type="text/javascript">
	  	$("#id_Prov").change(function(){
	    		var selectValues = $("#id_Prov").val();
	    		
				if (selectValues > 0){
					
					$.ajax({
							type: "GET",
							url : "<?php echo site_url('provinsi/select_kota')?>/" + selectValues,
							dataType: "JSON",
							...
							{	
								...
								$.each(data, function(i, item){
									...
									$('#id_Kota').append('<option value="Pilih Kota / Kabupaten">' + data[i].nama_kota_kab + '</option>');
					...
					$('#id_Kota').empty();
					$('#id_Kota').append('<option value="Pilih Kota / Kabupaten">-Pilih Provinsi Lebih Dahulu-</option>');
	    		}
	    });
	   </script>
...
function edit_data(id_provinsi)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('provinsi/ajax_edit')?>/" + id_provinsi,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="id"]').val(data.id_provinsi);
...
function delete_data(id_provinsi)
{
    if(confirm('Apakah kamu yakin akan menghapus data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('provinsi/ajax_delete')?>/"+id_provinsi,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Form Provinsi</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama_Provinsi" placeholder="Nama Provinsi" class="form-control" type="text">

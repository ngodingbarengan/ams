...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-folder-open"></i> DATA SATUAN</h3>
				</div>
			</div>
            <!-- page start-->
...
function edit_data(id_satuan)
{
    ...
    $.ajax({
        url : "<?php echo site_url('satuan/ajax_edit')?>/" + id_satuan,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="kd_Satuan"]').val(data.kd_satuan);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('satuan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('satuan/ajax_update')?>";
    }
...
function delete_data(id_satuan)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('satuan/ajax_delete')?>/"+id_satuan,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Form Satuan</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="kd_Satuan" placeholder="Kode Satuan" class="form-control" type="text">

...
function save()
{
    ...
    $.ajax({
        url : "<?php echo site_url('halaman/update_tentang_kami')?>",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
        ...
        {
			console.log(data);
			alert('Berhasil merubah isi halaman tentang kami');
        },
...
tinymce.init({
  ...
  setup: function (editor) {
      editor.on('init', function () {
		...
		$.ajax({
			url : "<?php echo site_url('halaman/get_isi_tentang_kami');?>",
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-pencil"></i> UBAH HALAMAN TENTANG KAMI</h3>
				</div>
			</div>
            <!-- page start-->

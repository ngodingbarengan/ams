...
function save()
{
    ...
    $.ajax({
        url : "<?php echo site_url('halaman/update_syarat_ketentuan')?>",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
tinymce.init({
  ...
  setup: function (editor) {
      editor.on('init', function () {
		...
		$.ajax({
			url : "<?php echo site_url('halaman/get_isi_syarat_ketentuan');?>",
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
...
<!--main content start-->
    <section id="main-content">
        <section class="wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="glyphicon glyphicon-pencil"></i> UBAH HALAMAN SYARAT DAN KETENTUAN</h3>
				</div>
			</div>
            <!-- page start-->

			...
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						...
						<li data-image="<?php echo base_url('upload/foto_produk').'/'.$produk->foto_1; ?>">

							<img src="<?php echo base_url('upload/foto_produk').'/'.$produk->foto_1; ?>" alt="">

						</li>
						<?php }?>

						<?php if(!empty($produk->foto_2)){ ?>
						<li data-image="<?php echo base_url('upload/foto_produk').'/'.$produk->foto_2; ?>">

							<img src="<?php echo base_url('upload/foto_produk').'/'.$produk->foto_2; ?>" alt="">

						</li>
						<?php }?>

						<?php if(!empty($produk->foto_3)){ ?>
						<li data-image="<?php echo base_url('upload/foto_produk').'/'.$produk->foto_3; ?>">

							<img src="<?php echo base_url('upload/foto_produk').'/'.$produk->foto_3; ?>" alt="">
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="<?php echo base_url('upload/foto_produk').'/'.$produk->foto_1; ?>" alt=""></div>
				</div>
				...
				<div class="col-lg-5 order-3">
					<div class="product_description">
						...
						<div class="product_name"><?php echo '<h2 class="text-primary">'.$produk->nama_produk.'<h2>'; ?></div>
						<div class="rating_r rating_r_4 product_rating"><i></i><i></i><i></i><i></i><i></i></div>
						<div class="product_text"><p><?php if($produk->deskripsi == "") { ?>
							...
							<?php $attributes = array('id' => 'myform'); ?>
								...
								<div class="clearfix" style="z-index: 1000;">
									...
									<div class="product_quantity clearfix">
										<span>Quantity: </span>
										<input id="quantity_input" name="jumlah" type="text" pattern="[0-9]*" value="1" onchange="validasi()">
								...
								<div class="product_price"><?php echo '<h4 class="text-danger"><strong>Rp. '.number_format($produk->harga, 0, '.', '.').'</h4>'; ?></div>
								<div class="button_container">
                                    ...
                                    <button type="button" class="button cart_button" onclick="location.href='<?php echo site_url('login_member');?>'">Add to Cart</button>
                                    <?php } ?>

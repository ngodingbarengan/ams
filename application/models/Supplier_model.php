...
class Supplier_model extends CI_Model {
	...
	var	$column_search = array('a.kd_member','a.nama','b.nama_provinsi','c.nama_kota_kab', 'd.nama_kecamatan'); //set column field database for datatable searchable
	...
	{ 
		...
		$this->db->where('tipe', 'SUPP_OFFLINE');
		//$query = $this->db->get();
